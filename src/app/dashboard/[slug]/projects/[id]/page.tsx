    ...
    <div className="w-full py-6 px-6 md:py-8 md:px-8 space-y-6 md:space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-1 font-semibold">
              ...
              <span className="premium-badge bg-primary-tint/50 text-primary border-primary/10">
                ID: {project.id}
              </span>
            </div>
          </div>
        ...
        <div className="flex gap-4">
          <Link href={`/dashboard/${slug}/projects/${id}/settings`}>
            <Button
              variant="outline"
              className="h-12 px-6 font-bold border-border bg-surface hover:bg-surface-hover rounded-xl text-text-secondary transition-all"
            >
              Project Settings
            </Button>
          </Link>
          <Link href={`/dashboard/${slug}/projects/${id}/realtime`}>
            <Button className="h-12 px-6 font-bold bg-primary text-white hover:bg-primary-dark shadow-lg shadow-primary/10 rounded-xl group transition-all hover:-translate-y-0.5">
              View Realtime
      ...
      {hasEvents ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Card className="lg:col-span-2 premium-card rounded-2xl overflow-hidden glass-card">
            <CardHeader className="pb-8 border-b border-border/50 bg-surface-raised/30 px-6 py-10">
              ...
              <CardDescription className="text-text-secondary font-medium text-base leading-relaxed mt-2 max-w-2xl">
            ...
            <CardContent className="space-y-10 px-6 py-10">
              <div className="space-y-4">
                ...
                <div className="p-8 rounded-2xl bg-sidebar-bg text-sidebar-text font-mono text-sm shadow-xl group relative overflow-hidden border border-white/5">
...
></script>`}
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-text-primary text-lg tracking-tight">
                  Testing your Setup
                </h4>
          ...
          <Card className="premium-card bg-primary-tint/5 backdrop-blur-sm self-start rounded-2xl overflow-hidden border border-primary/10">
            ...
            <CardContent className="space-y-10 px-6 py-10">
              <div className="space-y-3">
                <p className="font-bold text-text-primary text-lg tracking-tight flex items-center gap-2">
              ...
              <Button className="w-full mt-10 font-bold h-14 bg-primary text-white hover:bg-primary-dark shadow-lg shadow-primary/10 rounded-xl group transition-all hover:-translate-y-0.5">
                Read Documentation{" "}
