      ...
      <header className="bg-white border-b border-slate-200 py-4 px-6 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-bold text-slate-900">{organisation.name}</h1>
      ...
      <main className="max-w-7xl mx-auto py-8 px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="col-span-1 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader>
              <CardTitle className="text-slate-800 text-lg">Organization Info</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Slug</p>
          ...
          <Card className="col-span-1 md:col-span-2 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader>
              <CardTitle className="text-slate-800 text-lg">Team Members</CardTitle>
              <CardDescription>Everyone who has access to this dashboard.</CardDescription>
            </CardHeader>
            <CardContent>
